...
y_train = scaler.transform(hidden_X_train)

clf = MLPClassifier(solver='adam', alpha=1e-5, hidden_layer_sizes=(50, 50, 50, 50), random_state=1, max_iter = 100)
clf.fit(X_train, Y_train)
clf.score(X_test, Y_test)

clf.partial_fit(X_train, Y_train, classes = np.array([1,2,3]))

#With 3,3 and 10 iterations you can get 0.7135 acc.
'''
