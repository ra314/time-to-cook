...
data_train = [pd.concat(data["train"]["train"]["doc50"], axis = 1)]#, data["train"]["train"]["n_steps"]]#data["train"]["train"]["n_ingr"]]#, data["train"]["train"]["n_steps"]]
data_test = [pd.concat(data["train"]["test"]["doc50"], axis = 1)]#, data["train"]["test"]["n_steps"]]#data["train"]["test"]["n_ingr"]]#, data["train"]["test"]["n_steps"]]
data_Test = [pd.concat(data["test"]["doc50"], axis = 1)]#, data["test"]["n_steps"]]#data["test"]["n_ingr"]]#, data["test"]["n_steps"]]
...
# 71.1906% with 3k, ingr
# 69.36% with 2k, ingr
# 70.4688% with 3k, steps
# 
